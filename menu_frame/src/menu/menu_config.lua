...
images_catalog = {
    ...
    ['frame8'] = {
        ...
        -- ,['bottom'] = {dimensions = {x = 5, y = 30, width = 21, height =2}}
        -- ,['left'] = {dimensions = {x = 5, y = 6, width = 2, height =26}}
        -- ,['right'] = {dimensions = {x = 24, y = 6, width = 2, height =26}}
        ...
        ['panel1'] = {
            ...
            ['buttons'] = {
                ...
                ['button4'] = {
                    ...
                    ['position'] = { offsets = {top = 0, bottom = 10, left = 20, right = 20}},
                    ['callback'] = pressed_button,
                    ['display'] = {display = 'animals',image = 'platypus'}
                },
                ['button5'] = {
